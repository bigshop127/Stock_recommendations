...
// 截圖匯入（opt30）會夾帶 base64 圖片，遠超 express.json 預設的 100kb。
...
app.use('/api/rebalance/holdings-ocr', express.json({ limit: '20mb' }));
...
app.use(require('./routes/rebalance_ocr'));
...
app.use(require('./routes/stock_folders'));
app.use(require('./routes/stock_alerts'));
