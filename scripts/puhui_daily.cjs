...
| 項目 | 內容 |
| --- | --- |
| **近期表現** | <mark style="background:#FFCDD2">**雖為分盤處置，昨日仍大漲創波段新高**</mark>，強者恆強 |
| **外資評估** | <mark style="background:#FFCDD2">**大摩 + 小摩同步調高目標價，雙雙衝破千元大關**</mark>，預期成為千金股 |
...
- 主力推薦個股（國巨、華城、聯發科等當日重點）至少 6 列
- 一般觀察個股至少 4 列
- 螢光筆用在「關鍵訊號 / 操作建議 / 目標展望 / 外資評估」等決策性欄位
